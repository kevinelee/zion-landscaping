    ...
    <section className="flex flex-col lg:flex-row justify-center py-8 mx-auto max-w-screen-xl">
      ...
      <div className="lg:max-w-sm rounded overflow-hidden mx-2 my-3 lg:mb-0">
        ...
        <div className="px-6 py-4">
          <div className="font-bold text-xl mb-2">Lawn & Garden Care</div>
          <p className="text-gray-700 text-base">
            We understand that your property is a big investment and we want our
            customers to know that we are there for them to help them accomplish
            the dreams that they may have for there property....
          </p>
        </div>
      </div>
      <div className="lg:max-w-sm rounded overflow-hidden mx-2 my-3 lg:mb-0">
      ...
      <div className="lg:max-w-sm rounded overflow-hidden mx-2 my-3 lg:mb-0">
        ...
        <div className="px-6 py-4">
          ...
          <p className="text-gray-700 text-base">
            ...
            beauty. Whether you are looking for a brand new irrigation system to
            maintain your lawn or the replacement of a sprinkler...
          </p>
        </div>
      </div>
    </section>
